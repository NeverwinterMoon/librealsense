...
public enum Option {
    ...
    OPTION_OHM_TEMPERATURE(95),
    OPTION_SOC_PVT_TEMPERATURE(96),
    OPTION_GYRO_SENSITIVITY(97),
    OPTION_REGION_OF_INTEREST(98),
    OPTION_ROTATION(99),
    OPTION_SAFETY_PRESET_ACTIVE_INDEX(100),
    OPTION_SAFETY_MODE(101),
    OPTION_RGB_TNR_ENABLED(102),
    OPTION_SAFETY_MCU_TEMPERATURE(103),
    OPTION_LEFT_IR_TEMPERATURE(104),
    OPTION_EMBEDDED_FILTER_ENABLED(105);
